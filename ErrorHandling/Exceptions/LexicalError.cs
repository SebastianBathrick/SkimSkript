namespace SkimSkript.ErrorHandling.Exceptions
{
    ...
    public class LexicalError : LanguageError
    {
        ...
        /// <param _name="message"> Message describing why a token/lexeme is is invalid. </param>
        /// <param _name="lineNumber"> Line number the token/lexeme was found on in the source code. </param>
        /// <param _name="line"> Entire line of source code where the token/lexeme was found. </param>
