...
internal class TokenContainer
{
    ...
    public TokenType PeekType() => HasTokens ? _tokenList[_currentTokenIndex].Type : throw GetEndOfFileError();
    ...
    {
        tokenType = TokenType.Undefined;
        var checkIndex = _currentTokenIndex + offset;
    ...
    public override string ToString()
    {
        ...
        for (var i = _currentTokenIndex; i < _tokenList.Count; i++)
        {
