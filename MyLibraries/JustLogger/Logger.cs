namespace SkimSkript.MyLibraries.JustLogger;
...
public abstract class Logger
{
    ...
    public LockHandle AcquireLock() => new(_logLock!);
    #endregion
    ...
    protected static Segment[] GetSegmentedMessage(ReadOnlySpan<char> message, params object[] properties)
    {
        ...
        while (currentPos < message.Length)
        {
            ...
            var startPos = message.Slice(currentPos).IndexOf(MESSAGE_INSERT_START);
            ...
            var endPos = message.Slice(startPos + 1).IndexOf(MESSAGE_INSERT_END);
