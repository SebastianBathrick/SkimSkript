...
internal class Scanner
{
    ...
    private readonly Dictionary<char, CharType> _charTypeDict = FillCharTypeDict();
    ...
    private CharType GetCharType(char keyChar) =>
        _charTypeDict.TryGetValue(keyChar, out var value) ? value : CharType.WhiteSpaceOrPunctuation;
    ...
    private static Dictionary<char, CharType> GetPredefinedCharTypes() => new() // TODO: Migrate to syntax specs
