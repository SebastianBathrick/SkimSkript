...
{
    private readonly StackFrame _topLevelFrame;
    private readonly Stack<StackFrame> _functionCallStackFrames;
    ...
    public Node GetVariableValueCopy(string identifier)
    {
        ...
        return valueCopy != null ? valueCopy : throw UnknownIdentifierError(identifier);
    }
    ...
    public Type GetVariableDataType(string identifier)
    {
        ...
        return type != null ? type : throw UnknownIdentifierError(identifier);
    }
    ...
    public Node GetVariablePointer(string identifier)
    {
        ...
        return pointer != null ? pointer : throw UnknownIdentifierError(identifier);
    }
    #endregion
    ...
    private RuntimeException UnknownIdentifierError(string identifier) =>
        new($"Unknown identifier {identifier}");
}
